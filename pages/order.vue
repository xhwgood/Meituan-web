  ...
  <div class="page-order">
    <el-row>
      <el-col :span="4" class="navbar">
        <h3>
          <nuxt-link to="#" style="color: #222; display: inline-block;">
            我的美团
          </nuxt-link>
        </h3>
        <dl>
          ...
          <nuxt-link to="#">
            <dd>
              待使用<i class="el-icon-arrow-right" />
            </dd>
          </nuxt-link>
          <nuxt-link to="#">
            <dd>
              待评价<i class="el-icon-arrow-right" />
            </dd>
          </nuxt-link>
        </dl>
        <dl>
      ...
      <el-col :span="19" class="table">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="全部订单" class="all">
            <list :cur="cur" />
          </el-tab-pane>
          <el-tab-pane label="待付款" class="unpay">
            <list :cur="cur" />
          </el-tab-pane>
          <el-tab-pane label="待使用" class="unuse">
            <list :cur="cur" />
          </el-tab-pane>
          <el-tab-pane label="待评价" class="unreplay">
            <list :cur="cur" />
          </el-tab-pane>
        </el-tabs>
      </el-col>
